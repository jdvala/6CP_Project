...
encoder = tflearn.fully_connected(encoder, 256, restore='False')
encoder = tflearn.fully_connected(encoder, 64, restore='False')
encoder = tflearn.fully_connected(encoder, 10, activation='softmax', restore='False')
